...
Phase 0 / Phase 1 snapshot 固定为 `38f794fc19c3aaa988bfa78db0ae51143aab93ef`。在此基础上，首个真实 integration **MVMoE/4E + CVRP50** 已完成本地前 5 例 official-config GPU smoke、实际解提取、独立验证与 Kit 二次验证。其它 25 rows 未因此升级。
...
本轮 no training / no fine-tuning；未自动 commit/push，official source read-only。所有 smoke runtime 仅用于工程诊断，**NOT paper-comparable runtime**。
